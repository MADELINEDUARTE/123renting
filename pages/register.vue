                    ...
                    <div class="find-car-form col-12 col-sm-6 mx-auto">
                        <div class="d-flex justify-content-between">
                            <div class="d-flex justify-center flex-column">
                                <h4 class="find-car-title m-0">{{ $t('Creeunacuenta') }}</h4>
                            </div>
                        </div>
                        <form action="#" @submit.prevent="onSubmit">
                            <div class="row">
                                ...
                                <div class="form-group mb-4 col-12">
                                    <label>{{ $t('name') }}</label>
                                    <input type="text" v-model="dataForm.name" class="form-control" :placeholder="$t('YourName')" autocomplete="off" style="background-repeat: no-repeat !important; background-position: calc(100% - 3px) center !important; background-size: 14px !important; cursor: text;">
                                </div>
                                <div class="form-group mb-4 col-12">
                                    <label>{{ $t('EmailAddress') }}</label>
                                    <input type="email" v-model="dataForm.email" class="form-control" :placeholder="$t('YourEmail')" autocomplete="off" style="background-repeat: no-repeat !important; background-position: calc(100% - 3px) center !important; background-size: 14px !important; cursor: text;">
                                </div>
                                <div class="form-group mb-4 col-12">
                                ...
                                <div class="d-flex align-items-center col-12">
                                    <button type="submit" class="theme-btn"><i class="far fa-sign-in"></i> {{ $t('Registrar') }}</button>
                                </div>
                                <div class="d-flex justify-content-center my-4 align-items-center col-12">
                                    <p>
                                       {{ $t('Yatienescuenta') }}  
                                    </p>
                                    <nuxt-link  class="nav-link mx-2 active" to="/login">  {{ $t('Ingresa') }} </nuxt-link> 
                                </div>
                            </div>
                        </form>
                    </div>
